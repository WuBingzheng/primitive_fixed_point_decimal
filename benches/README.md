...
mul-rescale     |  3.62 | 11.97 |    \  ||  4.43 | 14.27 |    \  ||  1.92 |  4.89 |    \
mul-rescale-big |  5.71 | 19.42 | 37.54 ||  7.33 | 27.21 |104.34 ||  4.03 | 12.14 | 15.90
----------------+-------+-------+-------++-------+-------+-------++-------+-------+------
div-pure        |  2.91 |  8.08 | 10.35 ||  4.75 |  8.54 | 14.54 ||  1.91 |  1.59 |  4.19
div-rescale     |  6.16 | 10.99 | 57.52 || 17.11 | 20.43 | 59.36 ||  3.54 |  4.00 | 28.81
----------------+-------+-------+-------++-------+-------+-------++-------+-------+------
...
----------------+-------+-------+-------++-------+-------+-------++-------+-------+------
app             | 13.42 | 33.88 |129.82 || 17.15 | 42.58 |153.79 ||  5.96 | 16.56 | 49.61
```
...
----------------+-------+-------+-------++-------+-------+-------++-------+-------+------
mul-pure        |  0.32 |  0.32 |  9.40 ||  0.31 |  0.63 | 10.74 ||  0.31 |  0.31 |  2.88
mul-rescale     |  3.62 | 13.65 |    \  || 14.79 | 21.99 |    \  ||  1.92 |  5.33 |    \
mul-rescale-big |  5.71 | 19.42 | 37.54 ||  7.33 | 27.21 |104.34 ||  4.03 | 12.14 | 15.90
----------------+-------+-------+-------++-------+-------+-------++-------+-------+------
                |                       ||                       ||
```
...
mul-rescale     |  3.62 | 13.65 |    \  || 14.79 | 21.99 |    \  ||  1.92 |  5.33 |    \
----------------+-------+-------+-------++-------+-------+-------++-------+-------+------
app             | 13.42 | 40.11 |129.82 || 36.42 | 70.34 |153.79 ||  5.96 | 16.56 | 49.61
```
